...
import Income from "./components/Users/Income";
...
function App() {
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        <Route path="/" element={user ? <Dashboard /> : <HeroSection />} />
        ...
        <Route path="/income" element={ <AuthRoute> <Income /> </AuthRoute> } />
        <Route path="/project" element={ <AuthRoute> <Project /> </AuthRoute> } />
